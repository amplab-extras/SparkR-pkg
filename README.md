...
### Requirements
This branch of SparkR includes [DataFrame](https://spark.apache.org/docs/1.3.0/sql-programming-guide.html) support, and thus requires

* Scala 2.10, and
* Spark version >= 1.3.

Current build by default uses Apache Spark 1.3.0. You can also build SparkR against a
different Spark version (>= 1.3.0) by modifying `pkg/src/build.sbt`. To link SparkR against older versions of Spark, use the `master` branch.
